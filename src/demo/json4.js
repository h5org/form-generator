				...
				"rules": [
					...
					},
					{
						...
						"options": {
							...
							"values": {
								"active": 1,
								"group1.pay2": " this.getValue(\"group1.pay2\")",
								"pay2": " this.getValue(\"group1.pay2\")",
								"amountStr": "`<h2>${ this.getValue(\"group2.amount\")}元</h2>`"
							},
							"valueTypes": {
								"active": "number",
								"group1.pay2": "fx",
