...
import { generateKeyToTD, generateKeyToTH, generateKeyToCol, generateKeyToTab, fixDraggbleList, addClass, removeClass } from '../util/index.js'

export const widgetTabItemMixin = {
  ...
  methods: {
    handleMouseover (e) {
      !this.getDragging() && addClass(this.$refs['widgetTab'], 'is-hover')
    },
    handleMouseout (e) {
      removeClass(this.$refs['widgetTab'], 'is-hover')
    },
    handlePut (a, b, c) {
