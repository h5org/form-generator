<template>
  ...
  >
    ...
    >
      ...
      <input v-if="multiple" :accept="accept" multiple ref="uploadInput" @change="handleChange" type="file"  name="file" class=" upload_input">
      <input v-else :accept="accept" ref="uploadInput" @change="handleChange" type="file"  name="file" class=" upload_input">
    </div>
    ...
    <ul class="upload-list">
      ...
      >
        ...
        <template v-if="!printRead">
          ...
          <i class="fm-iconfont icon-close" v-if="!disabled" @click="handleRemove(item.key)" style="font-size: 12px;z-index:1;"></i>
