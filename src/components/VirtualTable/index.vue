        ...
        <div class="fm-virtual-table__header-content">
          ...
          >
            ...
            <template v-for="column in columns">
              <div class="fm-virtual-table__header-cell"
                :key="column.key"
                v-if="columnDisplay(column.model, column) && !column.options.fixedColumn"
                :style="{
      ...
      <div class="fm-virtual-table__header">
        <div class="fm-virtual-table__header-content">
          <div class="fm-virtual-table__header-row">
            ...
            >
              <div class="fm-virtual-table__header-cell-text" title="Column">
...
export default {
  ...
  computed: {
    rowWidthCalc () {
      let width = this.showControl ? '50px' : '0'
    ...
    rowLeftWidthCalc () {
      let width = this.widget.options.selection ? '50px' : '0px'
